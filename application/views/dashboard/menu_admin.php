        ...
        <div data-options="region:'west',split:true" title="Menu" style="width:15%;">
            <div class="easyui-accordion" data-options="fit:true,border:false">
                ...
                <ul class="easyui-tree">
                    ...
                    <li>
                        <span>
                            <a href="menu_dokumen.php">Dokumen</a>
                        </span>
                        <ul>
                ...
                <div title="Manage" data-options="selected:true" style="padding:20px;">
                    ...
                    <div id="formDialog" class="easyui-dialog " title="Register" style="width:400px;height:500px;padding:30px;" closed="true" buttons="#formButtons">
                        <form id="ff" method="post" action="<?= base_url('admin/registration') ?>">
                            ...
                            <button type="submit" href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm()" style="width:80px; margin: 5px;">Submit</button>
                            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="clearForm()" style="width:80px; margin: 5px;">Clear</a>
                            <a href="javascript:void(0)" class="easyui-linkbutton" onclick="closeForm()" style="width:80px; margin: 5px;">Close</a>
                        </form>
                    </div>
